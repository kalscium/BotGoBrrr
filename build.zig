...
pub fn build(b: *std.Build) void {
    ...
    const prac_driv = b.option(bool, "prac-driv", "Forces the driver to actually practice not maxing out joysticks");
    ...
    options.addOption(bool, "prac_driv", prac_driv orelse false);
